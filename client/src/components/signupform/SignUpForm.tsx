...
const SignUpForm = () => {
  ...
  return (
    <div className='bg-white h-full sm:pt-[200px] sm:w-full mx-auto overflow-hidden flex flex-col justify-center items-center py-16 text-black/70'>
            <Card className='sm:px-8 w-[95%] sm:w-[35%]'>
            <CardHeader>
